...
Usage inside Genie Code / a notebook (ambient auth):
    ...
    print(run_deid("testing_playground_catalog.deid_live_test.patients_raw"))
"""
...
if __name__ == "__main__":
    fqn = sys.argv[1] if len(sys.argv) > 1 else "testing_playground_catalog.deid_live_test.patients_raw"
