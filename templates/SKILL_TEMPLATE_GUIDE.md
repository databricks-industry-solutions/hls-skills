...
- [Review / textbook](https://example.com) — Description

## Related Skills

- `skill-name-1` — Brief connection to this guide
- `skill-name-2` — Brief connection to this guide

## Companion Assets

<!-- Optional. Only include if assets/ exists. -->
